...
class App extends Component {
  ...
  getNewFood() {
    ...
    if (_.includes(JSON.stringify(this.state.snakeDots), JSON.stringify(food))) food = this.getNewFood();
    return food;
  }
    ...
    return (
      <>
        ...
        <View>
          ...
          <Sound url="./sound/eat.mp3" playStatus={this.state.soundEat}
                 onFinishedPlaying={() => {this.setState({ soundEat: Sound.status.STOPPED });}}/>
          <Sound url="./sound/gameover.mp3" playStatus={this.state.soundGameOver}
                 onFinishedPlaying={() => {this.setState({ soundGameOver: Sound.status.STOPPED });}}/>
